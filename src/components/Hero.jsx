...
const Hero = () => {
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      <div
        className={`absolute inset-0 top-[120px] max-w-7xl mx-auto ${styles.paddingX} flex flex-col items-center justify-center text-center`}
      >
        {/* Main Content Container */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 w-full">
          {/* Left side - Purple line and dot */}
          ...
          <div className="flex flex-col items-center">
            ...
            {/* Profile Image Section */}
             <div className="flex flex-col items-center justify-center mb-6">
               <div className="relative">
                 {/* Gradient background circle - fading from purple to transparent */}
                ...
                <motion.div
                  className="absolute -top-2 -right-2 w-6 h-6 bg-[#915EFF] rounded-full opacity-80"
                  animate={{
                    scale: [1, 1.2, 1],
                    opacity: [0.8, 1, 0.8],
                  }}
                ...
                />
                <motion.div
                  className="absolute -bottom-2 -left-2 w-4 h-4 bg-purple-300 rounded-full opacity-70"
                  animate={{
                    scale: [1, 1.3, 1],
                    opacity: [0.7, 1, 0.7],
                  }}
            ...
            <p className={`${styles.heroSubText} text-white-100 max-w-2xl`}>
              I'm a freelancer from the Philippines, specializing in MERN Stack Development.
            </p>
          </div>

          {/* Right side - Purple line and dot (mirror) */}
          <div className='hidden md:flex flex-col justify-center items-center mt-5'>
            <div className='w-5 h-5 rounded-full bg-[#915EFF]' />
            <div className='w-1 h-40 violet-gradient' />
          </div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* React Icon */}
        <motion.div
          className="absolute top-32 right-32 text-[#61DAFB] opacity-20"
          animate={{
            y: [0, -20, 0],
            rotate: [0, 360],
          }}
        ...
        {/* JavaScript Icon */}
        <motion.div
          className="absolute top-48 left-20 text-[#F7DF1E] opacity-25"
          animate={{
            x: [0, 15, 0],
            y: [0, -10, 0],
          }}
        ...
        {/* Node.js Icon */}
        <motion.div
          className="absolute bottom-40 right-20 text-[#68A063] opacity-20"
          animate={{
            rotate: [0, -15, 15, 0],
            scale: [1, 1.1, 1],
          }}
        ...
        {/* CSS Icon */}
        <motion.div
          className="absolute top-60 left-32 text-[#1572B6] opacity-25"
          animate={{
            y: [0, 20, 0],
            x: [0, -10, 0],
          }}
        ...
        {/* MongoDB Icon */}
        <motion.div
          className="absolute bottom-32 left-40 text-[#47A248] opacity-20"
          animate={{
            scale: [1, 1.2, 1],
            rotate: [0, 5, -5, 0],
          }}
        ...
        {/* Git Icon */}
        <motion.div
          className="absolute top-80 right-40 text-[#F05032] opacity-25"
          animate={{
            rotate: [0, 360],
          }}
          transition={{
      ...
      {/* <ComputersCanvas /> */}
      {/* Uncomment the line above to bring back the 3D computer */}
